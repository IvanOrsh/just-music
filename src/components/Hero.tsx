      ...
      <div className="relative container mx-auto h-full flex justify-center items-center xl:justify-start ">
        ...
        <div className=" h-full flex flex-col justify-center items-center xl:items-start z-20 pt-12">
          ...
          <motion.div
            ...
            whileInView={"show"}
            viewport={{ once: false, amount: 0.3 }}
            className="min-h-[60px] flex items-center mb-6 text-2xl"
          >
        ...
        <motion.div
          ...
          className="hidden xl:flex absolute right-0 top-0 before:w-[784px] before:h-[893px] before:absolute before:right-0 before:top-0 before:bg-artistOverlay before:z-10"
        >
          <Image
